    ...
    <div className="flex flex-1 flex-col">
      ...
      <div className="flex flex-col space-y-4 p-4 md:flex-row md:items-center md:justify-between md:space-y-0 lg:flex-none">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden w-20 flex-col items-center justify-center rounded-lg border bg-muted p-0.5 md:flex">
              ...
              <div className="flex w-full items-center justify-center rounded-lg border bg-background p-0.5 text-lg font-bold">
                <span className="text-black">{format(today, "d")}</span>
              </div>
            </div>
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row md:gap-6">
          ...
          <div className="inline-flex w-full text-black -space-x-px rounded-lg shadow-sm shadow-black/5 md:w-auto rtl:space-x-reverse">
            <Button
      ...
      {/* Calendar Grid */}
      <div className="lg:flex lg:flex-auto lg:flex-col bg-glacev2 rounded-tl-md rounded-tr-md">
        {/* Week Days Header */}
        <div className="grid grid-cols-7 bg-glace rounded-tl-md rounded-tr-md text-center text-xs font-semibold leading-6 lg:flex-none">
              ...
              !isDesktop ? (
                ...
                <div
                  ...
                  className={cn(
                    ...
                    "relative flex flex-col bg-glace hover:bg-muted focus:z-10",

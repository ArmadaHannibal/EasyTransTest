...
const portfolioData = [
  {
    ...
    link: "/dashboard/Projects/Gestiondesticketsdebus/Gestionsdesbus",
    description:
      "Permettez aux utilisateurs d'acheter des tickets de bus en ligne, de sélectionner des itinéraires, des horaires et de gérer leurs réservations.",

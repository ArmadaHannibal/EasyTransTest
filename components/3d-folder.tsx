...
import { description } from "./componentspages/gestionsdeproject/appartementhotel/hart-pie-hotelchambreprise";
  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            "relative flex flex-col items-center justify-center p-8 rounded-2xl cursor-pointer bg-glace border border-border transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] hover:shadow-2xl hover:shadow-accent/20 hover:border-accent/40 group",
            className
          )}
          style={{
            minWidth: "280px",
        ...
        >
          ...
          <div className="text-left">
            ...
            <div className="absolute -bottom-4 right-[9.508rem]">
              <Chip
                color="warning"
                variant="shadow"
...
const portfolioData = [
  {
    title: "Gestion des Tickets de Bus",
    link: "/dashboard/Projects/Gestiondesticketsdebus",
    description:
      "Créez et gérez les trajets de bus, ajustez les prix et les disponibilités des billets selon les besoins des utilisateurs.",
    gradient: "linear-gradient(135deg, #e73827, #f85032)",
    projects: [
      {
        id: "b1",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1758192119/coworkers-designing-menswear-collection_lbbiol.jpg",
        title: "Lumnia Identity",
      },
      {
        id: "b2",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1758193216/portrait-teenager-sitting-desk-table-living-room_fm7ftt.jpg",
        title: "Agence de voyage",
      },
      {
        id: "b3",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1758193223/medium-shot-female-economist-holding-tablet_uwfeja.jpg",
        title: "Bus de voyage",
      },
      {
        id: "b4",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1758193240/medium-shot-people-with-coffee-cups_fpfg4v.jpg",
        title: "Ticket de bus",
      },
      {
        id: "b5",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1758196178/young-african-american-traveler-man-summer-hat-standing-with-suitcase-holding-air-tickets-smiling-cheerfully-positive-happy-blue-background_1_cdjccv.jpg",
        title: "Voyage",
      },
    ] as Project[],
  },
  {
    ...
    link: "/dashboard/Projects/Gestiondeshebergements",
    description:
      "Ajoutez et gérez les options d'hébergement (hôtels, appartements), ajustez les prix et les disponibilités selon les besoins des utilisateurs.",
    gradient: "linear-gradient(to right, #f7b733, #fc4a1a)",
    projects: [
      {
        id: "w1",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767635036/pexels-pixabay-164595_dskibe.webp",
        title: "Nexus Platform",
      },
      {
        id: "w2",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767635036/pexels-30nudos-adicora-164429726-13696645_1_w3sdtv.webp",
        title: "Echo Analytics",
      },
      {
        id: "w3",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767635037/pexels-pixabay-261053_jethyh.webp",
        title: "Flow Systems",
      },
      {
        id: "w4",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767635037/pexels-pixabay-261388_txdfkg.webp",
        title: "Aprt Nest",
      },
      {
        id: "w5",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767635038/pexels-quang-nguyen-vinh-222549-14024790_tzbe1h.webp",
        title: "Hotel Port",
      },
    ] as Project[],
  },
  {
    ...
    link: "/dashboard/Projects/Gestiondeslocationsdevoitures",
    description:
      "Gérez les locations de véhicules disponibles, ajustez les prix et les disponibilités selon les besoins des utilisateurs.",
    gradient: "linear-gradient(135deg, #00c6ff, #0072ff)",
    projects: [
      {
        id: "u1",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767636872/une-voiture-de-sport-avec-autoreglage-noir-blanc-conduisant-a-la-foret_gpt1f7.webp",
        title: "Crypto Wallet",
      },
      {
        id: "u2",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767636871/vue-de-face-d-une-berline-de-luxe-noire-sur-la-route_byhkz4.webp",
        title: "Social Connect",
      },
      {
        id: "u3",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767636871/jeep-de-luxe-noire-conduisant-sur-l-autoroute_nfrpkx.webp",
        title: "Health Tracker",
      },
      {
        id: "u4",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767636870/2021_Mercedes-AMG_GLE53_Coupe_electrifies_udh5nr.webp",
        title: "Finance Dash",
      },
      {
        id: "u5",
        image:
          "https://res.cloudinary.com/dtrpkegss/image/upload/c_fill,w_300,h_420,q_auto,f_auto/v1767636870/t%C3%A9l%C3%A9chargement_10_nrvj4c.webp",
        title: "UX Wireframe",
      },
    ] as Project[],
  },
...
export default function ComponentsAllProject() {
